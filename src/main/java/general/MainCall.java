...
public class MainCall {
    ...
    public final static HomePage hompePage = new HomePage();
    public final static ProductCategoryPage productCategoryPage = new ProductCategoryPage();
    public final static ProductPage productPage = new ProductPage();
    public final static CheckoutPage checkoutPage = new CheckoutPage();
