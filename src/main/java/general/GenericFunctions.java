...
//        action = new Actions(WebDriverFactory.getDriver());
    ...
    public List<WebElement> getRowsOfTable() {
        return WebDriverFactory.getDriver().findElement(CheckoutPage.table).findElements(CheckoutPage.rows);
...
//        catch (Exception e)
//        {
//            throw new (String.format("The element provided {0} is invalid", locator));
//        }
    ...
    {
        MainCall.webDriverFactory.getDriver().findElement(locator).sendKeys(input);
    }
    public static String getText(By locator)
    {
        return MainCall.webDriverFactory.getDriver().findElement(locator).getText();
    }
    public List<WebElement> getRows(By table,By row) {
        return WebDriverFactory.getDriver().findElement(table).findElements(row);

    }
    public static void hoverAndClickSubmenu(By main, By submenu)
    {
        action.moveToElement(WebDriverFactory.getDriver().findElement(main)).perform();
        action.moveToElement(WebDriverFactory.getDriver().findElement(submenu));
    ...
    public static List<String> getDropDownOptions(By locator)
    {
        ...
        WebElement select = MainCall.webDriverFactory.getDriver().findElement(locator);
        Select option = new Select(select);
        List<WebElement> elements = option.getAllSelectedOptions();
