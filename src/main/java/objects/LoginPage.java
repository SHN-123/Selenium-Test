...
public class LoginPage
{
    ...
    //Adding my Locators for login
    public static By login = By.xpath("//*[@id='customernav']/ul/li/a");
    public static By loginName = By.id("loginFrm_loginname");
    public static By loginPass = By.id("loginFrm_password");
    public static By loginButton = By.xpath("//*[@id='loginFrm']//button");
...
//    }
    ...
    {
        MainCall.genericFunctions.click(login);
    }

    public static void setName()
    {
        MainCall.genericFunctions.sendKeys(loginName, MainCall.envGlobals.loginName);
    }
    public static void setPassword()
    {
        MainCall.genericFunctions.sendKeys(loginPass, MainCall.envGlobals.loginPass);
    }
    public static void login()
    {
        MainCall.genericFunctions.click(loginButton);
    }
}
